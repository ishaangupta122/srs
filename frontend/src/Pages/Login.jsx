...
export default function Login() {
  ...
  return (
    <div
      ...
      <Card
        className={`w-full max-w-md p-6 shadow-2xl border ${
          darkMode ? "dark:bg-gray-800" : "border-green-900"
        } rounded-2xl transform transition-all hover:scale-105 hover:shadow-green-500/50 duration-300 animate__animated animate__fadeIn`}>
